...
**⚠️ 리팩토링을 시작하기 전에 `C-OSINE/.claude/golden_samples/` 디렉토리를 반드시 확인하여 프로젝트의 모범 사례와 패턴을 숙지하세요.**
...
상세 규칙: `C-OSINE/.claude/rules/REFACTORING.md` 참조
...
**상세 규칙:** `C-OSINE/.claude/rules/VERSION_CONTROL.md` 참조

---

## 📚 관련 문서

- `C-OSINE/.claude/context/` - 백엔드/프론트엔드 아키텍처 문서
- `C-OSINE/.claude/golden_samples/` - 패턴 및 모범 사례
- `C-OSINE/.claude/rules/` - 데이터 스키마, 리팩토링, 버전 관리 규칙
