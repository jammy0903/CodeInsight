...
## Phase 6: 학습 리포트 통합 (✅ 완료)

**완료 내용**:
- `StandaloneQuizSection` 컴포넌트 생성
- 언어별 취약 개념 Top 5 표시
- 오답률, 시도 횟수, 관련 문제 표시
- 진행률 바 시각화
- 퀴즈 페이지로 바로 이동 링크
...
- ✅ **언어별 선택**: C, JavaScript, Java, Python 전환 가능
- ✅ **상세 통계**: 오답률, 시도 횟수, 관련 문제
- ✅ **시각화**: 오답률 진행률 바
- ⏸️ **성장 그래프**: 주차별 정답률 변화 (향후 추가)
- ⏸️ **재시도 효과**: 재시도 시 정답률 향상 통계 (향후 추가)
...
// 실제 출력 예시:
// 🔴 포인터      ████████░░ 40% (15회 시도 중 8회 오답)
// 🟠 동적메모리   █████████░ 50% (10회 시도 중 5회 오답)
// 🟡 재귀함수     ██████░░░░ 30% (20회 시도 중 6회 오답)
```

**주요 기능**:
- 오답률에 따른 색상 변경 (빨강 → 주황 → 노랑)
- 최근 오답 문제 미리보기
- 해당 언어 퀴즈로 바로 이동 버튼
