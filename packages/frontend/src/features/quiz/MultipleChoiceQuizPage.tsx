      ...
      <div className="bg-[#fffbf5] min-h-screen px-3 py-6">
        <div className="w-full max-w-2xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-lg font-bold text-[#6b5a4a]">객관식 퀴즈</h1>
          ...
          {currentQuiz && (
            ...
            >
              <div className="bg-white rounded-2xl border-2 border-[#e5d5c7] p-6 mb-4 shadow-lg">
                <p className="text-lg text-[#6b5a4a] font-medium leading-relaxed">
                ...
                {currentQuiz.options.map((option, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[#6b5a4a] font-medium">{option}</span>
                    </div>
                  </motion.button>
                ))}
              </div>
