/**
 * JSAnimator - JavaScript Language Animator
 *
 * JavaScript 언어 전용 애니메이션 생성
 * - 변수 생성: 박스 나타남 + 값 떨어짐
 * - 값 변경: 값 교체 애니메이션
...
import type { IFlowAnimator } from '../../shared/adapters/types';
import { FLOW_ANIMATION } from '../../shared/styles';

export class JSAnimator implements IFlowAnimator {
  /**
   * 변수 생성 시 애니메이션
   * 1. 박스 생성 (scale 0 → 1)
   * 2. 값 떨어짐 (위에서 아래로)
...
// 싱글톤 인스턴스
export const jsAnimator = new JSAnimator();
